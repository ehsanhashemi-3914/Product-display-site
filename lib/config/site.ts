...
export const SITE = {
  name: "مهر نماز احسان",
  producer: "با مدیریت سید جواد هاشمی",
  tagline: "عرضهٔ مستقیم مهر نماز",
  description:
    "مهر نماز احسان، با مدیریت سید جواد هاشمی؛ بیش از ۲۰ سال سابقه و فروش بیش از ۴۰۰ میلیون مهر نماز. ارسال به سراسر کشور و کشورهای همسایه.",
  keywords: [
    "مهر نماز",
    "مهر تربت کربلا",
    "خرید مهر نماز",
  ...
  trust: [
    { icon: "award", label: "سابقهٔ فعالیت", value: "بیش از ۲۰ سال" },
