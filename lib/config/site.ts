...
export const SITE = {
  ...
  description:
    "مهر نماز احسان، با مدیریت سید جواد هاشمی؛ بیش از ۴۰ سال سابقه و فروش بیش از ۴۰۰ میلیون مهر نماز. ارسال به سراسر کشور و کشورهای همسایه.",
  keywords: [
    "مهر نماز",
    "مهر تربت کربلا",
    "خرید مهر نماز",
  ...
  trust: [
    { icon: "award", label: "سابقهٔ فعالیت", value: "بیش از ۴۰ سال" },
